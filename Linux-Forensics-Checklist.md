...
Dump ipsets (commonly used by fail2ban and firewalld):
```sh
...
TODO:
* Binaries: strings, hexdump, objdump, elf*, gdb, [rec](http://www.backerstreet.com/rec/rec.htm), [radare2](https://github.com/radare/radare2), IDAPro,…
